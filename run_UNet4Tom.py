...
import projection_games2D as PG
import UNet4Tom as UN
...
(targets, inputs) = PG.CreateDataSet(n_samp=2000,UseTorch=True)
ds = UN.ImageDataSet(inputs,targets)  # ds is an instance of this class
